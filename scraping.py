import os, re, shutil, requests,  webbrowser, customtkinter, random, subprocess, json
...
class scrap:
    def __init__(self, master):
        ...
        Label(master, bg="#363047", text="Payload", fg="white", font=(14)).place(x=950, y=30)
        ...
        self.st = customtkinter.CTkEntry(master, placeholder_text="XXX", width=100, height=25, border_width=2, corner_radius=5, fg_color = "#191621", text_color = "#80C148", border_color="#0E0C12")
        ...
        self.choseYourIp = customtkinter.CTkEntry(master, placeholder_text="255.0.0.0:PORT", width=130, height=25, border_width=2, corner_radius=5, fg_color = "#0E0C12", text_color = "#D69044", border_color="#000")
        ...
        customtkinter.CTkButton(master, width=60, height=40, text="Find", fg_color="#574E73", hover_color="#706494", text_color="black", border_width=1, corner_radius=5, border_color="#4B4363", command = self.threadFindHidden).place(x = 350, y = 270)
        customtkinter.CTkButton(master, width=60, height=40, text="Reload", fg_color="#574E73", hover_color="#706494", text_color="black", border_width=1, corner_radius=5, border_color="#4B4363", command = self.reload).place(x = 350, y = 330)
        customtkinter.CTkButton(master, width=60, height=30, text="Search", fg_color="#574E73", hover_color="#706494", text_color="black", border_width=1, corner_radius=5, border_color="#4B4363", command = self.searchLink).place(x = 350, y = 177.5)
        customtkinter.CTkButton(master, width=30, height=30, text="Servers", fg_color="#574E73", hover_color="#706494", text_color="black", border_width=1, corner_radius=5, border_color="#4B4363", command = self.openservers).place(x = 585, y = 263.5)
        ...
        self.yourUserAgent = customtkinter.CTkEntry(master, placeholder_text="Your User Agent (optional)", width=190, height=25, border_width=2, corner_radius=5, fg_color = "#191621", text_color = "#D0669F", border_color="#0E0C12")
        ...
        self.yourUserAgent.place(x = 665, y = 265)
